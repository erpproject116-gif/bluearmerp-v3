...
// computeEffectivePermissions mirrors runtime auth: role levels, then per-user overrides replace.
func computeEffectivePermissions(rolePerms, overrides map[string]string) map[string]string {
	out := map[string]string{}
