...
func listOpenSalesOrderLinesForWO(pool *pgxpool.Pool) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		...
		rows, err := pool.Query(r.Context(), openSalesOrderLineBalanceSQL()+`
