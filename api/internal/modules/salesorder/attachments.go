	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = pool.QueryRow(r.Context(), `
			insert into public.so_sales_order_attachments
			  (sales_order_id, file_name, mime_type, size_bytes, storage_path, uploaded_by_user_id)
			values ($1,$2,$3,$4,$5,$6)
			returning id, created_at`,
			salesOrderID, safeName, nullIfEmpty(mimeType), written, storagePath, tu.AppUserID).
			Scan(&id, &createdAt)
		if err != nil {
			_ = os.Remove(absPath)
