...
func uploadDir() string {
	return attachmentx.Dir("quotation")
}
	...
	return func(w http.ResponseWriter, r *http.Request) {
		...
		err = pool.QueryRow(r.Context(), `
			insert into public.quo_quotation_attachments
			  (quotation_id, file_name, mime_type, size_bytes, storage_path, uploaded_by_user_id, file_bytes)
			values ($1,$2,$3,$4,$5,$6,$7)
			returning id, created_at`,
			quotationID, safeName, nullIfEmpty(mimeType), written, storagePath, tu.AppUserID, data).
			Scan(&id, &createdAt)
		if err != nil {
