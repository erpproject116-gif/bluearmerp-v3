-- PHARMACY transactional copy overlay: re-theme printed narrative on seeded
...
begin
  ...
  loop
    ...
    update public.quo_quotations set
      quotation_validity_text = '7 DAYS',
      payment_terms = '30 days',
      note_for_pic_only = 'Verify batch/expiry and any prescription requirement before dispatch.',
      notes = E'Prices are inclusive of VAT.\nSubject to FDA-regulated stock availability.\nCold-chain items require validated delivery handling.\nPRICES ARE SUBJECT TO CHANGE WITHOUT PRIOR NOTICE.'
    where tenant_id = v_tenant;

    update public.sa_sales set payment_terms = '30 days'
    where tenant_id = v_tenant;

    update public.so_sales_orders set payment_terms = '30 days'
    where tenant_id = v_tenant;
  end loop;
end $$;
commit;
