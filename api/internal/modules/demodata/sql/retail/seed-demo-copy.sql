-- RETAIL transactional copy overlay: re-theme printed narrative on seeded
...
begin
  ...
  loop
    ...
    update public.quo_quotations set
      ...
      note_for_pic_only = 'Confirm branch stock before committing the delivery date.',
      notes = E'Prices are inclusive of VAT.\nStocks are subject to availability.\nWholesale/bulk pricing applies to full-case orders.\nPRICES ARE SUBJECT TO CHANGE WITHOUT PRIOR NOTICE.'
