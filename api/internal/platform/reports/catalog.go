...
func Catalog() []ReportDef {
	return []ReportDef{
		...
		{
			Key: "shipment_status", Label: "Shipment Status", Module: "sales-order",
			APIPath:    "/api/v1/shipping/reports/shipment-status",
			ExportPath: "/api/v1/shipping/reports/shipment-status/export",
			WebPath:    "/app/sales-order/reports/shipment-status", Tier: "R2",
			Description: "Shipped lines by shipping order for a date range.",
		},
		{
			Key: "pending_shipment", Label: "Pending Shipment", Module: "sales-order",
			APIPath:    "/api/v1/shipping/reports/pending-shipment",
			ExportPath: "/api/v1/shipping/reports/pending-shipment/export",
			WebPath:    "/app/sales-order/reports/pending-shipment", Tier: "R2",
			Description: "Sales order lines with quantity not yet shipped.",
		},
		{
			Key: "shipping_order_status", Label: "Shipping Order Status", Module: "sales-order",
			APIPath:    "/api/v1/shipping/reports/shipping-order-status",
			ExportPath: "/api/v1/shipping/reports/shipping-order-status/export",
			WebPath:    "/app/sales-order/reports/shipping-order-status", Tier: "R2",
			Description: "Shipping order line detail with freight for a date range.",
		},
		{
		...
		{
			Key: "po_status", Label: "Purchase Order Status", Module: "purchase-order",
			APIPath:    "/api/v1/purchase-order/purchase-orders/status-report",
			ExportPath: "/api/v1/purchase-order/purchase-orders/status-report/export",
			WebPath:    "/app/purchase-order/purchase-orders/status", Tier: "R3",
			Description: "PO line detail with progress and receipt status for a date range.",
		},
		{
			Key: "po_outstanding", Label: "Outstanding PO Status", Module: "purchase-order",
			APIPath:    "/api/v1/purchase-order/purchase-orders/outstanding-report",
			ExportPath: "/api/v1/purchase-order/purchase-orders/outstanding-report/export",
			WebPath:    "/app/purchase-order/purchase-orders/outstanding", Tier: "R3",
			Description: "Open PO lines with balance quantity pending receipt.",
		},
		{
		...
		},
		{
			...
			WebPath:    "/app/finance/acct-i/reports/trial-balance", Tier: "R5",
		...
		},
		{
			...
			WebPath:    "/app/finance/acct-i/reports/general-ledger", Tier: "R5",
		...
		},
		{
			...
			WebPath:    "/app/finance/acct-i/reports/profit-and-loss", Tier: "R5",
		...
		},
		{
			...
			WebPath:    "/app/finance/acct-i/reports/balance-sheet", Tier: "R5",
