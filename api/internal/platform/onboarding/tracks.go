...
var onboardingTracks = []trackDef{
	...
	},
	{
		...
		Steps: []trackStepDef{
			...
			{ID: "goods_receipt", Label: "Receive goods (Purchase Receive)", Href: "/app/purchases/purchase-receive", Description: "Post a purchase receive to increase stock and AP.", KbArticleID: "purchase-request-to-ap-flow", Required: false},
			{ID: "gr_serial_scan", Label: "Scan serials on receive", Href: "/app/purchases/purchase-receive", Description: "Scan item codes and serial numbers on draft receive lines.", KbArticleID: "serial-barcode-scanning", Required: false},
	...
	},
	{
		...
		Steps: []trackStepDef{
			...
			{ID: "serial_receive", Label: "Receive serials on Purchase Receive", Href: "/app/purchases/purchase-receive", Description: "Scan each unit when goods arrive.", Required: false},
