...
import (
	...
	"github.com/bluearm/bluearm-erp-v3/api/internal/modules/copilot"
	...
	"github.com/bluearm/bluearm-erp-v3/api/internal/modules/cms"
...
func main() {
	...
	r.Route("/api/v1", func(api chi.Router) {
		...
		api.Group(func(protected chi.Router) {
			...
			protected.Use(platformmw.RequireCommercialUnlocked(pool))
			...
			copilot.RegisterRoutes(protected, pool)
		})
	})
