...
import { jobsHref, modeFromPath, recipesHref, type MfgMode, MFG_COPY } from "./mfgProductionMode";
  ...
  return (
    <div class="mb-4 rounded-xl border border-stroke bg-slate-50/80 px-3 py-2">
      ...
      <p class="mt-0.5 text-[11px] text-text-secondary">
        Release and finish from the job list after you create a recipe and job.
      </p>
