...
const DISASSEMBLY_FLOW: ProductionFlow = {
  ...
  steps: [
    ...
    },
    {
      ...
      detail:
        "On the Jobs list, Next: Release to floor on the draft row. Floor links for weigh and receive appear on released rows.",
      href: "/app/production/disassembly/jobs",
      routePrefixes: ["/app/production/disassembly/jobs"],
      onJobsRow: true,
    },
    {
      ...
      label: "Weigh whole",
      short: "Floor",
      description: "Record actual input weight before cutting (catch-weight).",
      detail:
        "Open Weigh whole from the job row or Production → Weigh parts. Actual input drives output scaling and yield variance on complete.",
      href: "/app/production/weigh-parts",
      routePrefixes: ["/app/production/weigh-parts"],
    },
    {
      id: "receive",
      label: "Receive pieces",
      short: "Floor",
      description: "Stage output lots/pieces as they come off the line.",
      detail:
        "Receive pieces from the job row or Receive station (disassembly mode). Each output line from the recipe can get lot qty and optional per-piece weights.",
      href: "/app/production/receive-station?mode=disassembly",
      routePrefixes: ["/app/production/receive-station"],
    },
    {
      id: "qc",
