...
const ENTITY_PAIRS = [
  ...
  { source: "purchase_order", target: "supplier_invoice", label: "Bill ← Purchase Order (preferred)" },
  { source: "goods_receipt", target: "supplier_invoice", label: "Bill ← Purchase Receive (legacy)" },
];
