...
import { formatDisplayDate, statusExportUrl, type SalesStatusFilters } from "./salesStatusFilters";
...
export function SalesStatusReport(props: Props) {
  const auth = useAuth();
  ...
  return (
    <section class="mt-6 rounded-xl border border-stroke bg-white shadow-sm">
      <div class="border-b border-stroke px-5 py-4 text-center">
        <h2 class="text-xl font-bold text-text-primary">Sales Status</h2>
