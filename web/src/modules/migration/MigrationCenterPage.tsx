...
const OPEN_DOCS: EntityCard[] = [
  {
    kind: "open_quo",
    title: "Quotation",
    blurb: "Optional. Open quotations. item_code and qty optional; unmatched codes import as free-text.",
  ...
  },
  {
    kind: "open_so",
    title: "Sales Order",
    blurb: "Optional. Open sales orders. item_code and qty optional; blank rows skipped.",
  ...
  },
  {
    kind: "open_si",
    title: "Sales",
    blurb: "Optional. Remaining unpaid sales. item_code / qty optional — unmatched codes import as free-text; blank rows skipped.",
  ...
  },
  {
    ...
    blurb: "Optional. Open PRs. Partner, item_code, and qty optional; blank/noisy cells are skipped.",
  ...
  },
  {
    kind: "open_rfq",
    title: "RFQ",
    blurb: "Optional. Open RFQs. item_code and qty optional (qty defaults to 1).",
  ...
  },
  {
    ...
    blurb: "Optional. Open POs. item_code and qty optional; unmatched items become free-text lines.",
  ...
  },
  {
    kind: "open_ap",
    title: "Purchases",
    blurb: "Optional. Unpaid supplier invoices. item_code / qty optional; serial-tracked items skipped.",
