...
export const HELP_GOLDEN_QUERIES: HelpGoldenQuery[] = [
  ...
  { query: "serial count does not match quantity", path: "/app/inventory/serial-lot/receive", expectArticleId: "serial-count-mismatch" },
  ...
  { query: "serial count must equal", path: "/app/inventory/serial-lot/receive", expectArticleId: "serial-count-mismatch" },
