...
export const HELP_GOLDEN_QUERIES: HelpGoldenQuery[] = [
  ...
  { query: "recipe component shortage process post blocked", path: "/app/production/orders/new", expectArticleId: "mfg-recipe-assembly-shortage" },
  { query: "assembly not enough parts on hand", path: "/app/production/orders/new", expectArticleId: "mfg-recipe-assembly-shortage" },
  { query: "cutting raw material short post production", path: "/app/production/orders/new", expectArticleId: "mfg-cutting-shortage" },
  { query: "abnormal or excess waste requires a waste reason", path: "/app/production/orders/new", expectArticleId: "mfg-waste-reason-required" },
