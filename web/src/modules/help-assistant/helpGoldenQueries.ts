...
export const HELP_GOLDEN_QUERIES: HelpGoldenQuery[] = [
  // Existing baselines
  { query: "rfq workflow", path: "/app/purchase-order/rfq", expectArticleId: "rfq-workflow" },
  { query: "return serial", path: "/app/sales/sales-returns", expectArticleId: "sales-return-serial" },
  { query: "sales return vs repair order rma", path: "/app/after-sales/repair-orders", expectArticleId: "sales-return-vs-repair-rma" },
  { query: "defective unit rma not sales return", path: "/app/after-sales/repair-orders", expectArticleId: "sales-return-vs-repair-rma" },
  ...
  { query: "BA082126000181: Serial not found.", path: "/app/sales", expectArticleId: "serial-not-found-sale" },
  ...
  { query: "standard philippine chart of accounts", path: "/app/finance/acct-i/chart-of-accounts", expectArticleId: "chart-of-accounts-ph-template" },
  { query: "soft delete restore gl account", path: "/app/finance/acct-i/chart-of-accounts", expectArticleId: "coa-soft-delete-restore" },
  { query: "dashboard receivables payables", path: "/app/dashboard", expectArticleId: "dashboard" },
  { query: "home unpaid invoices", path: "/app/dashboard", expectArticleId: "dashboard" },
  { query: "today calendar hourly day view", path: "/app/operations/calendar", expectArticleId: "operations-calendar-day-today" },
  { query: "edit operations industry pack columns", path: "/app/operations/packs", expectArticleId: "operations-packs-edit" },
  { query: "menu or screen is missing permission", path: "/app/dashboard", expectArticleId: "missing-menu-permission" },
  ...
  { query: "goods receipt with serial numbers", path: "/app/purchases/purchase-receive/new", expectArticleId: "goods-receipt-serial-receive" },
  ...
  { query: "active branch wrong warehouse", path: "/app/inventory", expectArticleId: "multi-branch-defaults" },
  ...
  { query: "why can't I confirm", path: "/app/quotation/quotations", expectArticleId: "cannot-confirm-document" },
  { query: "Please fill in required fields", path: "/app/sales", expectArticleId: "cannot-confirm-document" },
  { query: "attach a file before confirming", path: "/app/quotation/quotations", expectArticleId: "document-attachments-workflow" },
  { query: "Please fill in required fields: Progress status", path: "/app/quotation/quotations", expectArticleId: "quotation-progress-status" },
  { query: "empty chart of accounts", path: "/app/finance/acct-i/chart-of-accounts", expectArticleId: "chart-of-accounts-ph-template" },
  { query: "today button not working", path: "/app/operations/calendar", expectArticleId: "operations-calendar-day-today" },
  { query: "google calendar day view", path: "/app/operations/calendar", expectArticleId: "operations-calendar-day-today" },
  { query: "cash in after invoice", path: "/app/finance/official-receipts", expectArticleId: "official-receipt-after-si" },
  { query: "pay supplier invoice", path: "/app/finance/payment-vouchers", expectArticleId: "payment-voucher-after-purchase" },
  { query: "gr before supplier invoice", path: "/app/user-management/process-policies", expectArticleId: "process-policy-gates-explained" },
  { query: "you do not have permission", path: "/app/dashboard", expectArticleId: "missing-menu-permission" },
  { query: "serial count must equal", path: "/app/purchases/purchase-receive/new", expectArticleId: "serial-count-mismatch" },
  ...
  { query: "how to scan serial barcode", path: "/app/purchases/purchase-receive/new", expectArticleId: "serial-barcode-scanning" },
  ...
  { query: "finish setup first", path: "/app/setup", expectArticleId: "foundation-setup-blocked-api" },
  { query: "system pack read only", path: "/app/operations/packs", expectArticleId: "operations-packs-edit" },
  { query: "create capa from ncr", path: "/app/quality", expectArticleId: "quality-ncr-capa-loop" },
  { query: "issue bom components", path: "/app/manufacturing", expectArticleId: "manufacturing-wo-issue-complete" },
  { query: "recipe component shortage process post blocked", path: "/app/production/recipe/jobs/new", expectArticleId: "mfg-recipe-assembly-shortage" },
  { query: "assembly not enough parts on hand", path: "/app/production/assembly/jobs/new", expectArticleId: "mfg-recipe-assembly-shortage" },
  { query: "cutting raw material short post production", path: "/app/production/cutting/jobs/new", expectArticleId: "mfg-cutting-shortage" },
  { query: "abnormal or excess waste requires a waste reason", path: "/app/production/cutting/jobs/new", expectArticleId: "mfg-waste-reason-required" },
  { query: "waste reason cutting manufacturing", path: "/app/production/waste-reasons", expectArticleId: "mfg-waste-reason-required" },
