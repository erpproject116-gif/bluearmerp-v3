    ...
    <div class="mb-8 space-y-4">
      ...
      <Show when={d()}>
        ...
        <div class="grid gap-3 sm:grid-cols-2 lg:grid-cols-5">
          ...
          <A href="/app/finance/receivables" class="rounded-xl border border-stroke bg-white p-4 shadow-sm hover:border-brand-300">
          ...
          <A href="/app/finance/payables" class="rounded-xl border border-stroke bg-white p-4 shadow-sm hover:border-brand-300">
