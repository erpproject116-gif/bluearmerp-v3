...
export default function SerialBalanceReportPage() {
  ...
  const [submitted, setSubmitted] = createSignal<SerialBalanceFilters | null>(null);
  ...
  return (
    <SerialLotLayout>
      <section class="rounded-xl border border-stroke bg-white p-5 shadow-sm">
        <div class="mb-4">
          <h2 class="text-lg font-semibold text-text-primary">Serial Inv. Balance</h2>
          <p class="text-sm text-text-secondary">As-of quantity by serial — Search (F8).</p>
        </div>
