...
export default function ItemCategoriesPage() {
  ...
  const canWrite = () => hasPermission(auth.me, "inventory.item_categories", "write");
  ...
  return (
    <div class="mx-auto max-w-5xl p-4">
      <h1 class="mb-1 text-xl font-semibold text-text-primary">Item categories</h1>
      <p class="mb-4 text-sm text-text-secondary">
        Deactivate categories to hide them from item pickers. Inactive categories remain on existing items.
      </p>
