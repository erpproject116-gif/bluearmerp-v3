...
async function fetchSlips(id: number) {
  const res = await apiFetch<CreatedSlipLine[]>(`/api/v1/purchase-request/purchase-requests/${id}/created-slips`);
...
export function CreatedSlipModal(props: Props) {
  const [data] = createResource(
    () => (props.open && props.purchaseRequestId ? props.purchaseRequestId : null),
