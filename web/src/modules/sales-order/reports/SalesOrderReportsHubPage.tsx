...
const links = [
  { label: "Fulfillment progress", href: "/app/sales-order/reports/fulfillment-progress", blurb: "Delivery and billing completion by order." },
  ...
  { label: "Sales order status", href: "/app/sales-order/sales-orders?view=status", blurb: "Status board for sales orders." },
  { label: "Open orders", href: "/app/sales-order/sales-orders?view=outstanding", blurb: "Orders not yet closed." },
];
