...
type Props = {
  value: () => SalesOrderStatusFilters;
  onChange: (next: SalesOrderStatusFilters) => void;
  onSearch: () => void;
  onReset: () => void;
};
...
export function SalesOrderStatusFilter(props: Props) {
  ...
  const patch = (p: Partial<SalesOrderStatusFilters>) => props.onChange({ ...props.value(), ...p });
