...
export default function ItemDemandReportPage() {
  ...
  const [submitted, setSubmitted] = createSignal<ItemDemandFilters | null>(null);
  ...
  return (
    <CrmLayout>
      <section class="rounded-xl border border-stroke bg-white p-5 shadow-sm">
        <h2 class="text-lg font-semibold text-text-primary">Item demand</h2>
        <p class="text-sm text-text-secondary">Quoted vs sold quantities per item — Search (F8).</p>
