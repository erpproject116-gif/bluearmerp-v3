  ...
  },
  {
    ...
    blocks: [
      ...
      },
      {
        type: "steps",
        items: [
          "On New Sales / sales invoice, use Scan serial (document bar or SERIAL / LOT cell). An in-stock unit auto-fills the item line.",
          "Each accepted scan adds one unit; you cannot save without matching serial count.",
          "Serials must already be in stock (Purchase Receive confirmed). A serial listed only on a PO will show “Serial not found” until received.",
