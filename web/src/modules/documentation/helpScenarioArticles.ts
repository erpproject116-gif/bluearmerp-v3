...
export const helpScenarioArticles: KbArticle[] = [
    ...
    blocks: [
      {
        type: "steps",
        items: [
          "Open Accounting → Ledger → Chart of accounts (/app/finance/acct-i/chart-of-accounts).",
    ...
    blocks: [
      {
        type: "steps",
        items: [
          "Open Accounting → Ledger → Bank reconciliation.",
    ...
    blocks: [
      {
        type: "steps",
        items: [
          "Open Accounting → Ledger → Journal entries and open the draft.",
  ...
  // ─── P2: Module depth ───────────────────────────────────────────────────
  {
    ...
    primaryHref: "/app/production/orders/new?type=recipe",
  ...
  },
  {
    ...
    primaryHref: "/app/production/orders/new?type=cutting",
