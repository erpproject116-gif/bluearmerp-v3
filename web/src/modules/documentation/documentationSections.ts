...
export const documentationSections: DocSection[] = [
  ...
  },
  {
    ...
    title: "Pages",
    iconId: "cms",
    intro: "Write pages for your signed-in team, and publish Bluearm articles on the public /articles catalog.",
    primaryHref: "/app/cms",
    primaryLabel: "Open Pages",
    blocks: [
      {
        type: "paragraph",
        text: "Pages lives under More apps. Use it for store notices, how-to write-ups, and Bluearm articles. The public catalog at /articles is the platform marketing tenant (BLUEARM) — visitors do not sign in. Other workspaces’ pages stay in Pages admin and are not listed on /articles. Search engines can open the public URLs. Old /app/articles and /app/cms/p links still redirect.",
      },
      {
        type: "steps",
        items: [
          ...
          "On the page editor, set Topic cluster and Slug — the permalink is /articles/{topic}/{slug} and is shown above the form. Write in Visual or Markdown, or paste a generated .md file (title, topic, slug, and SEO fill in).",
          ...
          "Upload pictures from Media, or use Image URL / YouTube on the Visual toolbar. HTTPS image URLs and YouTube watch links are allowed.",
          "Click Publish when the page is ready. Share the published URL /articles/{topic}/{slug} — for example /articles/bodega-at-stock/meron-pa-na-palaging-mali. Topic cluster and slug are editable on the editor (the permalink preview). Open published opens in a new tab. Old /app/articles/{topic}/{slug} and /app/cms/p/{slug} links still redirect.",
  ...
  },
  {
    ...
    blocks: [
      ...
      {
        type: "tip",
        text: "Complete always reloads the live BOM. Used qty goes into the product; scrap/spare is extra measurable qty in the same UoM. Golden demos S14–S16 cover MTO, MTS, and fabric disassembly — see Knowledge base → Production.",
      },
    ],
  },
  {
