...
export const workflowGuides: WorkflowGuide[] = [
  {
    ...
    steps: [
      ...
      },
      {
        id: "payment",
        short: "Payment",
        title: "Record the payment (Receivables)",
        what: "When the customer pays, open Accounts → Receivables (open balances), find their invoice, and apply payment. Or use Cash In right after saving the sale. The invoice then shows as paid and your receivables stay accurate.",
        href: "/app/finance/receivables",
        routePrefixes: ["/app/finance/receivables", "/app/finance/official-receipts"],
        moduleCode: "finance",
      },
    ],
  },
  {
    ...
    steps: [
      ...
      },
      {
        id: "pay",
        short: "Payables",
        title: "Pay the supplier (Payables)",
        what: "Open Accounting → Payables (open balances), find the Bill, and apply payment. Or use Cash Payment right after saving the purchase. The Bill then shows as paid and your payables stay accurate.",
        href: "/app/finance/payables",
        routePrefixes: ["/app/finance/payables", "/app/finance/disbursements", "/app/finance/payment-vouchers"],
        moduleCode: "finance",
