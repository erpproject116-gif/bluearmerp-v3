...
export const workflowGuides: WorkflowGuide[] = [
  ...
  {
    id: "manufacturing",
    title: "Production — BOM to stock to sell",
    summary:
      "Define the recipe (BOM), run work orders (from a sales order or make-to-stock), release, optionally QC and scan serial/lot, complete into inventory, then sell.",
    docHref: "/app/documentation/kb/manufacturing-bom",
    steps: [
      {
        id: "bom",
        short: "BOM",
        title: "Define the recipe (Bill of materials)",
        what: "List components and quantities for each finished item. Keep the BOM accurate before you start shop-floor work.",
      ...
      },
      {
        ...
        what: "Make-to-stock: New work order. Make-to-order: Sales order → Create work order, or Work orders → Sales order (Load Slip).",
      ...
      },
      {
        id: "release",
        short: "Release",
        title: "Release the work order",
        what: "Release moves the job to the floor. For serial/lot items, open Issue materials and Receive FG from the work order row.",
      ...
      },
      {
        ...
        what: "When Production QC is on in Process policies, Hold/Release FG inspection on the work order before Complete.",
      ...
      },
      {
        id: "complete",
        short: "Complete",
        title: "Complete into stock, then sell",
        what: "Complete posts material issue and finished goods. Then release or invoice from Sales using on-hand stock.",
        href: "/app/production/work-orders?status=released",
        routePrefixes: ["/app/production/work-orders", "/app/sales-order", "/app/sales"],
        moduleCode: "manufacturing",
      },
    ],
  },
