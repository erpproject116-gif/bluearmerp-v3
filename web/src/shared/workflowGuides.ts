  ...
  },
  {
    ...
    steps: [
      ...
      },
      {
        ...
        what: "Make-to-stock: New work order. Make-to-order: From sales order (Load Slip) on Work Orders, or create from the Sales Order screen.",
      ...
      },
      {
        ...
        what: "Release to floor starts the job. Pass FG QC when required. For serial/lot items, use Issue and Receive FG from the work order row.",
