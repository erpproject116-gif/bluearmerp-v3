...
export const workflowGuides: WorkflowGuide[] = [
  ...
  {
    id: "manufacturing",
    title: "Manufacturing — BOM to work order",
    summary:
      "Define how a finished good is made (bill of materials), then issue and complete work orders to consume components and produce stock.",
    ...
    steps: [
      {
        ...
        what: "List components and quantities for each finished item. Keep the BOM accurate before you issue shop floor work.",
        href: "/app/manufacturing/boms",
        routePrefixes: ["/app/manufacturing/boms"],
        moduleCode: "manufacturing",
      },
      {
        id: "wo",
        short: "Work orders",
        title: "Issue and complete work (Work orders)",
        what: "Create a work order, issue components from stock, then complete to receive finished goods into inventory.",
        href: "/app/manufacturing/work-orders",
        routePrefixes: ["/app/manufacturing/work-orders", "/app/manufacturing"],
        moduleCode: "manufacturing",
      },
    ],
  },
