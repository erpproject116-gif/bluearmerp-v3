...
export const UI_COPY_GROUPS: UiCopyGroup[] = [
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        fallback: "Attachments (carried from Purchase Order/Receiving)",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    title: "Goods receipt",
    entries: [
      { key: "goods_receipt.list_title", label: "List page title", fallback: "Goods Receipt List" },
      { key: "goods_receipt.list_description", label: "List page description", fallback: "Goods receipts created from purchase orders." },
      { key: "goods_receipt.receive_goods", label: "Receive goods button", fallback: "Receive goods" },
      { key: "goods_receipt.scan_serials", label: "Scan serials panel title", fallback: "Scan serials" },
      { key: "goods_receipt.open_in_receive", label: "Open in receive link", fallback: "Open in Receive" },
      { key: "goods_receipt.draft_only_scans", label: "Draft-only scans message", fallback: "Only draft receipts accept serial scans." },
      { key: "goods_receipt.receive_page_title", label: "Receive page title", fallback: "Receive / Scan Serials" },
