...
export function TaxMngtHeaderNav() {
  ...
  return (
    <Show when={isTaxMngtPath(loc.pathname)}>
      <nav class="mt-3 flex flex-wrap gap-1" aria-label="Tax Management features">
        {taxMngtNavLinks.map((link) => (
          <A
            ...
            classList={{
              ...
              "text-text-secondary hover:bg-slate-50 hover:text-text-primary": !isTaxMngtNavLinkActive(
                loc.pathname,
                link,
              ),
            }}
