...
export const appModules: AppModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Item Inv. Book", href: "/app/inventory/reports/inv-book", settingsHref: "/app/inventory/stock-movements", headerPriority: "primary" },
      {
      ...
      { label: "Stock Ledger", href: "/app/inventory/reports/stock-ledger", settingsHref: "/app/inventory/stock-movements", headerPriority: "primary" },
      ...
      { label: "Inventory Status", href: "/app/inventory/reports/inventory-status", settingsHref: "/app/inventory/stock-movements", headerPriority: "overflow" },
