...
export type ModuleFeature = {
  ...
  /** When true, feature stays routable but is omitted from header tabs. */
...
export const appModules: AppModule[] = [
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Item categories", href: "/app/inventory/item-categories", settingsHref: "/app/inventory/item-categories", headerPriority: "overflow" },
      { label: "Stock Movements", href: "/app/inventory/stock-movements", settingsHref: "/app/inventory/stock-movements/settings", headerPriority: "primary" },
      { label: "Stock Adjustments", href: "/app/inventory/stock-adjustments", settingsHref: "/app/inventory/stock-adjustments/settings", headerPriority: "primary" },
      { label: "Stocks Transfer", href: "/app/inventory/stock-entries", settingsHref: "/app/inventory/stock-entries/settings", headerPriority: "primary" },
      { label: "Stock Reconciliation", href: "/app/inventory/stock-reconciliation", settingsHref: "/app/inventory/stock-reconciliation", headerPriority: "overflow" },
      { label: "Inv. Balance by Location", href: "/app/inventory/find-stock", settingsHref: "/app/inventory/find-stock", headerPriority: "primary" },
      {
        label: "Serials",
      ...
      { label: "Item Inv. Book (history)", href: "/app/inventory/reports/inv-book", settingsHref: "/app/inventory/reports/inv-book", headerPriority: "overflow" },
      {
        label: "Serial Inv. Book (history)",
      ...
      {
        label: "Lot Inv. Book (history)",
        href: "/app/inventory/serial-lot/reports/lot-book",
        settingsHref: "/app/inventory/serial-lot/settings",
        featureCode: "inventory.serial_lot",
        headerPriority: "overflow",
      },
      { label: "Stock Ledger", href: "/app/inventory/reports/stock-ledger", settingsHref: "/app/inventory/reports/stock-ledger", headerPriority: "overflow" },
      { label: "Stock Balance", href: "/app/inventory/reports/stock-balance", settingsHref: "/app/inventory/reports/stock-balance", headerPriority: "overflow" },
      { label: "On Hand", href: "/app/inventory/reports/on-hand", settingsHref: "/app/inventory/reports/on-hand", headerPriority: "overflow" },
      { label: "Stock Ageing", href: "/app/inventory/reports/stock-ageing", settingsHref: "/app/inventory/reports/stock-ageing", headerPriority: "overflow" },
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Purchase Status", href: "/app/buying/reports/purchase-status", settingsHref: "/app/purchases/purchase-receive/settings" },
      { label: "Pre-Invoicing (Purchases)", href: "/app/purchases/purchase-receive/pre-invoicing", settingsHref: "/app/purchases/purchase-receive/settings" },
  ...
  },
  {
    ...
    features: [
      { label: "Quotations", href: "/app/quotation/quotations", settingsHref: "/app/quotation/quotations/settings", headerPriority: "primary" },
      {
        label: "Quote board",
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Accounts receivable by customer", href: "/app/sales/reports/ar-by-customer", settingsHref: "/app/sales/sales/settings" },
  ...
  },
  {
    ...
    features: [
      { label: "Sales orders", href: "/app/sales-order/sales-orders", settingsHref: "/app/sales-order/sales-orders/settings", headerPriority: "primary" },
      ...
      { label: "Sales order analysis", href: "/app/sales-order/reports/so-analysis", settingsHref: "/app/sales-order/sales-orders/settings" },
  ...
  },
  {
    ...
    features: [
      { label: "Purchase orders", href: "/app/purchase-order/purchase-orders", settingsHref: "/app/purchase-order/purchase-orders/settings", headerPriority: "primary" },
      ...
      { label: "Purchase order analysis", href: "/app/purchase-order/reports/po-analysis", settingsHref: "/app/purchase-order/purchase-orders/settings" },
  ...
  },
  {
    ...
    features: [
      { label: "Purchases", href: "/app/purchases/purchase-receive", settingsHref: "/app/purchases/purchase-receive/settings", headerPriority: "primary" },
      {
      ...
      {
        label: "Pre-invoicing",
        href: "/app/purchases/purchase-receive/pre-invoicing",
        settingsHref: "/app/purchases/purchase-receive/settings",
      },
      {
        label: "Payment status",
        href: "/app/purchases/purchase-receive/payment-status",
        settingsHref: "/app/purchases/purchase-receive/settings",
      },
      {
        label: "A/P by vendor",
  ...
  },
  {
    ...
    features: [
      ...
      { label: "Quality check requests", href: "/app/quality/qc-requests", settingsHref: "/app/quality/ncrs" },
