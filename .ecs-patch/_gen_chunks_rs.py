...
# Prefer chunk-based exact upload + phaseC2 build
chunks = []
for i in range(12):
    chunks.append((base / f"chunk{i}.b64").read_text(encoding="utf-8").strip())
...
reset = _b64.b64encode(b'rm -f /tmp/slip.go.hex\\necho RESET').decode()
outs.append(await run_b64(reset, 60))
