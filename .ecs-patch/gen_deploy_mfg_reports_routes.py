...
rebuild_phase = "\n".join(
    [
        ...
        "grep -n 'listWorkOrderStatusReport' api/internal/modules/manufacturing/reports.go | head -1",
...
body = make_runner(
    ...
    result = {
        'ok': 'DEPLOY_MFG_REPORTS_DONE' in out and health_code == '200' and report_code == '401',
...
out_path = pathlib.Path(__file__).parent / "_deploy_mfg_reports_routes_fix.py"
